...
class MS_Addon_Attributes extends MS_Addon {
	...
	public function register( $list ) {
		$list[ self::ID ] = (object) array(
			'name' => __( 'Mitgliedschaftsattribute', 'membership2' ),
			'description' => __( 'Füge Deinen Mitgliedschaften benutzerdefinierte Attribute hinzu, die Du in Shortcodes und Code verwenden kannst.', 'membership2' ),
	...
	public function add_settings_tab( $tabs ) {
		$tabs[ self::ID ] = array(
			'title' => __( 'Mitgliedschaftsattribute', 'membership2' ),
	...
	public function enqueue_settings_scripts() {
		...
		$data = array(
			'lang' => array(
				'edit_title' => __( 'Attribut bearbeiten', 'membership2' ),
			),
		);
	...
	public function help_page() {
		...
		<div id="<?php echo self::SHORTCODE; ?>" class="ms-help-box">
			...
			<?php _ex( 'Gibt den Wert eines benutzerdefinierten Mitgliedschaftsattributs aus.', 'help', 'membership2' ); ?>
			...
			<div class="ms-help-details" style="display:none">
				<ul>
					<li>
						...
						<?php _ex( 'Slug des benutzerdefinierten Attributs', 'help', 'membership2' ); ?>.
					</li>
					<li>
						<code>id</code>
						<?php _ex( '(Einzel ID)', 'help', 'membership2' ); ?>
						<?php _ex( 'Die Mitgliedschaft ID', 'help', 'membership2' ); ?>.
						<span class="ms-help-default">
							<?php _ex( 'Standard:', 'help', 'membership2' ); ?>
							<?php _e( 'Automatische Erkennung', 'membership2' ); ?>
						</span><br />
						<em><?php _ex( 'Wenn nicht angegeben, versucht das Plugin, die aktuell angezeigte Mitgliedschaft zu identifizieren, indem es die URL überprüft, Daten und Abonnements des aktuellen Mitglieds anfordert', 'help', 'membership2' ); ?></em>.
					</li>
					<li>
						<code>title</code>
						<?php _ex( '(yes|no)', 'help', 'membership2' ); ?>
						<?php _ex( 'Stelle der Ausgabe den Feldtitel voran', 'help', 'membership2' ); ?>.
						<span class="ms-help-default">
							<?php _ex( 'Standard:', 'help', 'membership2' ); ?>
							no
						</span>
					...
					<li>
						<code>default</code>
						<?php _ex( '(Text)', 'help', 'membership2' ); ?>
						<?php _ex( 'Standardwert, der angezeigt wird, wenn keine Mitgliedschaft gefunden wurde oder die Mitgliedschaft das Attribut nicht definiert hat', 'help', 'membership2' ); ?>.
						<span class="ms-help-default">
							<?php _ex( 'Standard:', 'help', 'membership2' ); ?>
							""
						</span>
