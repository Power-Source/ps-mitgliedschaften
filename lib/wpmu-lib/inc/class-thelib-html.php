...
class MsTheLib_Html extends MsTheLib  {
	...
	public function _enqueue_pointer() {
		...
		wp_enqueue_script( 'psmembership-lib-pointer-polyfill', plugins_url( 'pointer-polyfill.js', __FILE__ ), array( 'jquery' ), '1.0.0', true );
		wp_enqueue_style( 'psmembership-lib-pointer-polyfill', plugins_url( 'pointer-polyfill.css', __FILE__ ), array(), '1.0.0' );
	}
