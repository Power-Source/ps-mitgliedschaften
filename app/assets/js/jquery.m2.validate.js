...
(function(factory) {
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            email: "PBitte gib eine gültige E-Mail-Adresse ein.",
            url: "Bitte gib eine gültige URL ein.",
            date: "Bitte gib ein korrektes Datum an.",
            dateISO: "Bitte gib ein gültiges Datum ein (ISO).",
            ...
            rangelength: $.validator.format("Bitte gib einen Wert zwischen {0} und {1} Zeichen ein."),
            ...
            step: $.validator.format("Bitte gib ein Vielfaches von {0} ein.")
        },
        ...
        methods: {
            ...
            url: function(value, element) {
                ...
                // Simplified URL validation to prevent ReDoS attacks
                // Validates basic URL structure with protocol, domain, and optional path
                if (this.optional(element)) {
                    return true;
                }
                
                // Try using native URL constructor for validation (most secure)
                try {
                    var url = new URL(value);
                    // Only allow http, https, and ftp protocols
                    return /^(https?|ftp):$/i.test(url.protocol);
                } catch (e) {
