...
class MS_Controller_Adminbar extends MS_Controller {
			...
			$wp_admin_bar->add_node(
				apply_filters(
					...
					array(
						...
						'title'  => __( 'M-Simulation', 'membership2' ),
						'href'   => $link_url,
						'meta'   => array(
							'class'    => 'ms-test-memberships',
							'title'    => __( 'Mitgliedersimulationsmenü', 'membership2' ),
							'tabindex' => '1',
						),
					)
				)
	...
	private function add_unprotected_node() {
		...
		$wp_admin_bar->add_node(
			apply_filters(
				...
				array(
					'id'     => 'ms-unprotected',
					'title'  => __( 'Der Inhaltsschutz ist deaktiviert', 'membership2' ),
					'href'   => $link_url,
					'meta'   => array(
						'class'    => 'ms-unprotected',
						'title'    => __( 'Der Inhalt dieser Webseite ist ungeschützt', 'membership2' ),
						'tabindex' => '1',
					),
				)
			)
	...
	private function add_cache_notice() {
		...
		$wp_admin_bar->add_menu(
			array(
				...
				'title' => __( 'Mitgliedschafts-Cache aktiviert', 'membership2' ),
				'href'  => '#',
				'meta'   => array(
					'class'    => 'membership-cache-notice',
					'title'    => __( 'Die Mitgliedschaft ist aktiviert, um Daten zwischenzuspeichern', 'membership2' ),
					'tabindex' => '1',
				)
			)
		);
	...
	private function add_detail_nodes() {
		...
		$wp_admin_bar->add_menu(
			array(
				...
				'title' => __( 'Schutzdetails', 'membership2' ),
				'href'  => '#',
			)
		);
	...
	public function enqueue_scripts() {
		$data = array(
			...
			'switching_text' => __( 'Umschalten...', 'membership2' ),
		);
