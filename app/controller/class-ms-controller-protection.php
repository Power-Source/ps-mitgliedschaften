...
class MS_Controller_Protection extends MS_Controller {
	...
	public function enqueue_scripts() {
		...
		switch ( $this->get_active_tab() ) {
			case 'url':
				$data['valid_rule_msg'] 	= __( 'Gültig', 'membership2' );
				$data['invalid_rule_msg'] 	= __( 'Ungültig', 'membership2' );
				$data['empty_msg'] 			= __( 'Vor dem Testen musst Du zuerst eine oder mehrere der oben genannten Seiten-URLs eingeben.', 'membership2' );
